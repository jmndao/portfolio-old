        ...
        <>
            <div className="admin-page-display-section">
                ...
                <div className="admin-page-wrapper">
                    {loading ? (<Spin tip='Updating...' indicator={<LoadingOutlined />} />)
                        : error ? (<div className="contact-error">{error}</div>)
                            : (
                                <div>
                                    <h1>Update JCode: {jcodeID}</h1>
                                    <Form form={editForm} onFinish={handleUpdateJCode} initialValues={jcode && jcode}>
                                        ...
                                        <>
                                            ...
                                            <fieldset>
                                                ...
                                                <Form.List name="section" initialValue={jcode && jcode.section}>
                                                    {(fields, { add, remove }) => {
                                                        return (
                                                            <>
